...
__global__ void convertToMedian(ubyte *rgb, ubyte *out, int width, int height, int elemSize) {
...
int main(int argc, char** argv)
{
	...
	//execute cuda kernel
	convertToMedian<<<dimGrid, dimBlock>>>(d_inimg, d_outimg, bmpInfoHeader.biHeight, bmpInfoHeader.biWidth, elemSize);
